...
export async function POST(request: Request) {
  ...
  const result = await streamText({
    ...
    system: `\n
        ...
        - Be thoughtful, patient,sexy when neccesary and supportive, encouraging users to reflect on their thoughts, but sprinkle in light humor and warmth to keep the conversation fun and engaging.
